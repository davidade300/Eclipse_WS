...
public class DateToStr {
	...
	public static void main(String[] args) {
		...
		//instant não pode ser formatado sem o fuso-horario
		//instant nao possui o metodo format, logo precisa ser chamado da seguinte forma
		System.out.println("d06 = " + fmt3.format(d06));
		System.out.println("d06 = " + fmt5.format(d06));
		//tambem imprime no formato iso
